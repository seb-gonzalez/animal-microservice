...
public class AnimalController {
    ...
    static {
        ANIMAL_APIS.put("cats", "https://placekitten.com/200/300");
        ANIMAL_APIS.put("dogs", "https://place.dog/200/300");
        ANIMAL_APIS.put("bears", "https://placebear.com/200/300");
    }
    ...
    public ResponseEntity<Object> captureAnimals(@RequestBody CaptureRequest request) {
        ...
        if (animal == null || animal.isEmpty() || count <= 0) {
            return ResponseEntity.badRequest()
                .body(Map.of("error", "Missing or invalid animal/count"));
        }

        if (!ANIMAL_APIS.containsKey(animal)) {
            return ResponseEntity.badRequest()
                .body(Map.of("error", "Unsupported animal type. Use 'cats', 'dogs', or 'bears'"));
        }
